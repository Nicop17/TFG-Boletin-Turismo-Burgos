...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\textbf{Descripción}          & El componente central del código (main\_scraper\_pipeline.py) se encarga de gestionar el ciclo de vida del programa, asegurando que los módulos se activen en el orden correcto y controlando la sesión. \\
